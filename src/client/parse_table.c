...
xdd_func_t  xdd_func[] = {
    ...
    {"datapattern", "dp",
            xddfunc_datapattern,
            1,
            "  -datapattern <c> | random | sequenced | prefix <hexdigits> | inverse | ascii <asciistring> | hex <hexdigits> | file <file_name> | wholefile <file_name> | replicate | lfpat | ltpat | cjtpat | crpat | cspat\n",
    ...
    {"endtoend", "e2e",
            xddfunc_endtoend,
            1,
            "  -endtoend  issource | isdestination | islocal | destination <hostname[:baseport#[,portcount]]> | destination <file_name> | port <#> | portcount <#>\n",
  ...
  The word 'when' should be replaced with the word: \n\
    ...
    {"ordering", "or",
            xddfunc_ordering,
            1,
            "  -ordering <storage | network | both>  <serial | loose | none>\n",
    ...
    {"readafterwrite","raw",
            ...
            1,
            "  -readafterwrite trigger <stat | mp> | lag <#> | reader <hostname> | port <#>\n",
    ...
    {"restart", "rst",
            xddfunc_restart,
            1,
            "  -restart enable | frequency <seconds> | file <name_of_restart_file> | offset <offset_in_bytes>\n",
    ...
    {"seek",  "s",
            xddfunc_seek,
            1,
            "  -seek save <filename> | load <filename> | disthist #buckets | seekhist #buckets | sequential | random | range #blocks | stagger #blocks | interleave #blocks | seed # | none\n",
    ...
    {"target", "target",
            xddfunc_target,
            1,
            "  -target <filename> [<option> <value> ...]\n",
            {"    Declares a single target file/device and may include undashed per-target options in the same scope\n",
             "    Example: -target file1 blocksize 64k numreqs 32\n",
             "    Legacy inline forms like '-blocksize target N ...' are still accepted for compatibility\n",
             0,0},
			0},
    {"targetdir",   "td",
            xddfunc_targetdir,
            1,
            "  -targetdir <directory_name>\n",
    ...
    {"targets", "targets",
            xddfunc_targets,
            1,
			"  -targets # <filename...> [<option> <value> ...]\n  -targets -# <filename> [<option> <value> ...]\n",
            {"    Declares multiple targets and may include undashed per-target options applied to the declared range\n",
             "    Requires number of files plus list of target file/device names\n",
			 "    If the number is negative, duplicate the single file/device name # times; legacy inline target forms remain supported\n",
             0,0},
			0},
    ...
    {"throttle", "throt",
            xddfunc_throttle,
            1,
            "  -throttle <ops|bw|var> <#.#ops | #.#MB/sec | #.#var>\n",
    ...
    {"timestamps", "ts",
            xddfunc_timestamp,
            1,
            "  -ts summary|detailed|wrap|oneshot|size #|append|output <filename>|dump <filename>|triggertime <seconds>|triggerop <op#>\n",
