...
"${XDDTEST_XDD_EXE}" -targets 2 "${test_file}" "${test_file2}" -op target 0 write -op target 1 write -blocksize 1m -numreqs 512 -runtime 2 -hb 1 -hb tgt -hb output "${test_dir}/data3"
